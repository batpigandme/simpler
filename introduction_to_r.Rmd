...
After that will be an explanation of that chunk of code, and what each bit is doing and how everything in it works. There are also likely to be lines starting with #: these are comments, which are ignored by R when code is run. This is useful because it lets you document what the code is doing within your R program.
