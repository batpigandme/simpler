...
So for database connecting, we need to wrap all the code above in a function that accepts `db` and `query` as arguments, and returns the results of the database query. Simple enough:
