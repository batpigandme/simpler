...
Much cleaner! We can also use `stringr` to clean up some of the strangeness we saw in the exploratory data analysis - the extraneous spaces that appear in some (otherwise identical) strings, with `str_trim`:
